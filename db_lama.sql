...
--
-- Host: localhost
-- Generation Time: Aug 03, 2023 at 11:58 PM
...
CREATE TABLE `financials` (
  ...
  `category` enum('additional','deductions') NOT NULL,
...
(1, 'admin', 'web', '2023-07-09 21:46:19', '2023-07-09 21:46:19');
...
CREATE TABLE `users` (
  ...
  `gender` enum('male','female','hidden') NOT NULL,
